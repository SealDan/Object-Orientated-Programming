...
int main() {
    const double USD_TO_GBP = 0.82, EURO_TO_GBP = 0.84, CNY_TO_GBP = 0.11, SGD_TO_GBP = 0.6, MYR_TO_GBP = 0.18; //exchange variable
    double GBP = 0, USD = 0, EURO = 0, CNY = 0, SGD = 0, MYR = 0; //initialize amount for each currency
    ...
    //Exchange each currency to GBP and Sum
